...
export const SEED_USERS: SeedUser[] = [
  {
    id: u(1), identityId: i(1), personId: p(1), email: 'admin@sambo.local', displayName: 'Администратор платформы', totp: true,
  ...
  {
    id: u(2), identityId: i(2), personId: p(2), email: 'federation@sambo.local', displayName: 'Руководитель федерации', totp: false,
  ...
  {
    id: u(3), identityId: i(3), personId: p(3), email: 'organizer@sambo.local', displayName: 'Организатор турнира', totp: false,
  ...
  {
    id: u(4), identityId: i(4), personId: p(4), email: 'manager1@sambo.local', displayName: 'Директор СШ «Самбо-Север»', totp: false,
  ...
  {
    id: u(5), identityId: i(5), personId: p(5), email: 'manager2@sambo.local', displayName: 'Руководитель клуба «Витязь-У»', totp: false,
  ...
  {
    id: u(6), identityId: i(6), personId: p(6), email: 'coach1@sambo.local', displayName: 'Тренер Самбо-Север', totp: false,
  ...
  {
    id: u(7), identityId: i(7), personId: p(7), email: 'coach2@sambo.local', displayName: 'Тренер Витязь-У', totp: false,
  ...
  {
    id: u(8), identityId: i(8), personId: p(8), email: 'referee1@sambo.local', displayName: 'Судья 1', totp: false,
    person: { lastName: 'Судейкин', firstName: 'Андрей', birthDate: '1980-04-18', gender: 'MALE' },
    grants: [],
  },
  {
    id: u(9), identityId: i(9), personId: p(9), email: 'referee2@sambo.local', displayName: 'Судья 2', totp: false,
